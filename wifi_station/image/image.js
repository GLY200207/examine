...
const devicesId = "643437689" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "KQnulKTjxC4ZDTpkaM=HYtgur=0=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
...
Page({
  ...
  convert: function (datapoints) {
    ...
    var length = datapoints.time.length
    for (var i = 0; i < length; i++) {
      categories.push(datapoints.time[i].at.slice(5, 19));
